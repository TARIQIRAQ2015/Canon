...
╠══════════════════════════════════════════════════════════════════╣"""
    ...
    if color_pages > 0:
        price = color_pages * 1000  # سعر الطباعة الملونة
        summary_text += f"""
║ 🎨 طباعة ملونة:                                                  ║
║    • عدد الصفحات: {color_pages} صفحة                                        ║
║    • سعر الصفحة: 1,000 دينار                                     ║
║    • المجموع: {price:,} دينار                                     ║
╟──────────────────────────────────────────────────────────────────╢"""

    if bw_color_pages > 0:
        price = bw_color_pages * 750  # سعر الطباعة أبيض وأسود مع قليل ألوان
        summary_text += f"""
║ 🖌️ طباعة أبيض وأسود وقليل ألوان:                                ║
║    • عدد الصفحات: {bw_color_pages} صفحة                                        ║
║    • سعر الصفحة: 750 دينار                                       ║
║    • المجموع: {price:,} دينار                                     ║
╟──────────────────────────────────────────────────────────────────╢"""

    if bw_pages > 0:
        price = bw_pages * 500  # سعر الطباعة أبيض وأسود
        summary_text += f"""
║ 📄 طباعة أبيض وأسود:                                            ║
║    • عدد الصفحات: {bw_pages} صفحة                                        ║
║    • سعر الصفحة: 500 دينار                                       ║
║    • المجموع: {price:,} دينار                                     ║
╟──────────────────────────────────────────────────────────────────╢"""
